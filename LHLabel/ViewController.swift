...
class ViewController: UIViewController {
    ...
    let imageView =   UIImageView.init(image: UIImage.init(named: "lantian.jpg"))
        ...
        mm.backgroundColor = UIColor.init(colorLiteralRed: 0.1, green: 0.5, blue: 0.8, alpha: 0.1)
...
//        mm.exclusionPaths = [p]
        ...
        let att = NSMutableAttributedString.init(string: "沧海月明珠有泪，蓝田日乱玉生烟，此情可待成追忆，只是当时已惘然")
